namespace ExpenseManager.Web.Migrations.TODELETE
{
    //using System;
    //using System.Data.Entity.Migrations;
    
    //public partial class UserInterface : DbMigration
    //{
    ...
    //                })
    //            .PrimaryKey(t => t.Guid)
    //            .ForeignKey("dbo.UserProfile", t => t.Creator_Guid)
    ...
    //            .PrimaryKey(t => t.Guid)
    //            .ForeignKey("dbo.Currency", t => t.Currency_Guid)
    //            .ForeignKey("dbo.UserProfile", t => t.Guid)
    //            .Index(t => t.Guid)
    //            .Index(t => t.Currency_Guid);
    ...
    //                })
    //            .PrimaryKey(t => t.Id)
    //            .ForeignKey("dbo.UserProfile", t => t.Profile_Guid)
    //            .Index(t => t.UserName, unique: true, name: "UserNameIndex")
    //            .Index(t => t.Profile_Guid);
    ...
    //        DropForeignKey("dbo.AspNetUsers", "Profile_Guid", "dbo.UserProfile");
    ...
    //        DropIndex("dbo.AspNetUsers", new[] { "Profile_Guid" });
