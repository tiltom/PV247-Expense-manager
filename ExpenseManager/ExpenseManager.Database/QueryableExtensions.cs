...
{
    /// <summary>
    /// Mainly asynchronous extensions of <see cref="IQueryable{T}"/> that would otherwise only be available via EntityFramework.
    /// </summary>
    public static class QueryableExtensions
    {
        ...
        /// <returns>A task that represents the asynchronous operation. The task result contains a System.Collections.Generic.List`1 that contains elements from the input sequence.</returns>
